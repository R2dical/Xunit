...
namespace Xunit
{
	...
	public sealed class DefaultExcelDataAttribute : DataAttribute
	{
		readonly static string connectionTemplate = "Provider=Microsoft.ACE.OLEDB.12.0; Data Source={0}; Extended Properties='Excel 12.0;HDR=YES;IMEX=1;';";
		readonly string _fileName;
		readonly string _queryString;

		public DefaultExcelDataAttribute(string fileName, string queryString)
		{
			_fileName = fileName;
		...
		public override IEnumerable<object[]> GetData(MethodInfo testMethod)
		{
			...
			return DataSource(_fileName, _queryString, pars.Select(par => par.ParameterType).ToArray());
		}
